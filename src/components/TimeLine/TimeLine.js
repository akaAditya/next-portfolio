...
const Timeline = () => {
  ...
  return (
    <Section>
      ...
      <SectionText>
        Web Development is one of the best stream for a great a career in this
        Digital World. I define myself by the work I do. Skills can be taught,
        personality is inherent.
        <br />
        <br />
        I prefer to keep learning, continue challenging myself to accelerate
        thinking abilities. I am passionate, expressive, multi-talented spirit
        with a natural ability to entertain and inspire.
        <br />
        <br />I am a fast learner, able to pick up new skills and juggle
        different projects and roles with relative ease. I like to develop
